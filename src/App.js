...
const App = () => {
    ...
    const pages = [{id: 0, title: "Products", content: <Products inventory={inventory}/>},
                   {id:1, title:"Customer Analytics", content: <CustomerAnalytics inventory={inventory} sortedCustomers={sortedCustomers} updateSort={setSortedCustomers}/>},
    ...
    useEffect(() => {
        ...
        .then((tempInventory) => {
            ...
            .then((result) => {
                    ...
                    setCurrentPage({ id: 0, title: "Products", content: <Products inventory={tempInventory} /> });
                    setIsLoaded(true);
    ...
    return (
        <div className={classes.app}>
            ...
            <article className={classes.mainBody}>
                <h2 className={classes.bodyHeader}>{isLoaded ? currentPage.title : "Loading..."}</h2>
